...
import { Dimensions, Keyboard, TextInput, ScrollView, Platform, View, KeyboardAvoidingView } from 'react-native';
...
class ChatBot extends Component {
  ...
  render() {
    ...
    if (inputAttributesOverride.keyboardType === 'default' && this.state.count === 0) {
      Keyboard.dismiss()
